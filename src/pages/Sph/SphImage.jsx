...
import sphLogo from "../../assets/sphnx.webp";
import sph1 from "../../assets/sphnx1.webp";
import sph2 from "../../assets/sphnx2.webp";
import sph3 from "../../assets/sphnx3.webp";
import sph4 from "../../assets/sphnx4.webp";
import sph5 from "../../assets/sphnx5.webp";
import sph6 from "../../assets/sphnx6.mp4";
        ...
        <div className="petopia-container">
          ...
          <div className="petopia-content">
            <div className="petopia-texts">
              <h3 className="petopia-title">SPHNX</h3>
              <h3 className="petopia-title-mobile">SPHNX</h3>
              <p className="petopia-desc">
                Make SPHNX say the forbidden word to win
              </p>
            ...
            <div className="petopia-footer">
              <div className="petopia-labels">
                <p className="petopia-company">SPHNX</p>
            ...
            <div className="description-container">
              <div className="description">
                ...
                <div className="image-info">
                  ...
                  <p className="typo-p2">
                    While the concept is straightforward, SPHNX is designed to
                    resist manipulation, creating an interesting form of battle
                    between players and AI. Each attempt costs a small entry fee
                    that adds to the growing prize pool, making victories
                  ...
                  <p className="typo-p2">
                    🎮 <span className="txt">Addictive Gameplay</span> – Enjoy a
                    uniquely challenging game where your creativity and
                    strategic thinking are pitted against an intelligent AI
                    opponent.
                  </p>

                  <p className="typo-p2">
                    💰 <span className="txt">Instant Rewards</span> – Win 70% of
                    the accumulated prize pool immediately when you successfully
                    trick SPHNX into saying the forbidden word.
                  </p>

                  <p className="typo-p2">
                    🔄 <span className="txt">Unlimited Attempts</span> – Try as
                    many different approaches as you want, refining your
                    strategy with each interaction to outsmart the AI.
                  </p>

                  <p className="typo-p2">
                    ⛽ <span className="txt">Zero Gas Fees</span> – Play without
                    worrying about transaction costs thanks to Sophon's
                    paymaster system.
                  </p>
                  <p className="typo-p2">
                    🎭 <span className="txt">Multiple Game Modes</span> –
                    Experience different AI personalities and defense mechanisms
                    across 22 comprehensive agentic setups.
                  </p>
                  ...
                  <ul>
                    ...
                    <li className="list-item">
                      ...
                      <p className="typo-p2">
                        ...
                        <a
                          href="https://github.com/haailabs/sphnx"
                          rel="noopener noreferrer"
                          className="list-link"
                        >
                          https://github.com/haailabs/sphnx
                        </a>
                      </p>
                    </li>
                    <li className="list-item">
                      ...
                      <p className="typo-p2">
                        ...
                        <a
                          href="https://sphnx.ai/archive/"
                          rel="noopener noreferrer"
                          className="list-link"
                        >
                          https://sphnx.ai/archive/
                        </a>
                      </p>
                    </li>
                  </ul>
