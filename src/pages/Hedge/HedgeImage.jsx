...
import hedgeLogo from "../../assets/hedgeempire.svg";
import hedge1 from "../../assets/hedgeempire1.webp";
import hedge2 from "../../assets/hedgeempire2.webp";
import hedge3 from "../../assets/hedgeempire3.webp";
import hedge4 from "../../assets/hedgeempire4.webp";
import hedge5 from "../../assets/hedgeempire5.webp";

const logos = [hedge1, hedge2, hedge3, hedge4, hedge5];
        ...
        <div className="petopia-container">
          ...
          <div className="petopia-content">
            <div className="petopia-texts">
              <h3 className="petopia-title">Hedge Empire</h3>
              <h3 className="petopia-title-mobile">Hedge Empire</h3>
            ...
            <div className="petopia-footer">
              <div className="petopia-labels">
                <p className="petopia-company">Hedge Empire</p>
            ...
            <div className="description-container">
              <div className="description">
                ...
                <div className="image-info">
                  ...
                  <p className="typo-p2">
                    Hedge Empire is a financial strategy game where you build
                    and manage your own hedge fund empire. Make smart decisions
                    about hiring traders, upgrading your office, and investing
                    in better technology to grow your profits. Hedge Empire is a
                    fully onchain idle game that combines financial simulation,
                    real yield mechanics, and progressive automation powered by
                    the $FUND token.
                  </p>
                  ...
                  <p className="typo-p2">
                    🎮 <span className="txt">Fully Onchain Idle Gameplay</span>{" "}
                    – Build your financial empire while collecting $FUND through
                    traders who produce continuous yield.
                  </p>
                  <p className="typo-p2">
                    📈{" "}
                    <span className="txt">Realistic Progression Mechanics</span>{" "}
                    – Experience authentic fund management with break-even
                    structures, salaries, hiring costs, and revenue planning.
                  </p>

                  <p className="typo-p2">
                    🏢 <span className="txt">Upgradeable Infrastructure</span> –
                    Scale your operation with larger office spaces and
                    productivity-boosting AI algorithms.
                  </p>

                  <p className="typo-p2">
                    👥{" "}
                    <span className="txt">
                      Referral System and LP Incentives
                    </span>{" "}
                    – Earn rewards from referred players plus additional $FUND
                    and $SOPH for providing liquidity.
                  </p>

                  <p className="typo-p2">
                    🔥 <span className="txt">Deflationary Tokenomics</span> –
                    70% of every in-game purchase is burned, creating long-term
                    value for active players.
                  </p>

                  <p className="typo-p2">
                    💰 <span className="txt">Dynamic Token Emission</span> –
                    $FUND is minted exclusively through gameplay, directly tied
                    to your performance and engagement.
                  </p>

                  <p className="typo-p2">
                    Whether you're a strategist, casual optimizer, or liquidity
                    farmer, Hedge Empire rewards decision-making over
                    speculation.
                  </p>
