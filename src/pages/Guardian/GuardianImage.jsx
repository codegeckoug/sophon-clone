...
import guardianLogo from "../../assets/guardian.webp";
import guardian1 from "../../assets/guardian1.webp";
import guardian2 from "../../assets/guardians2.webp";
import guardian3 from "../../assets/guardians3.webp";
import guardian4 from "../../assets/guardians4.webp";
import guardian5 from "../../assets/guardians5.webp";
const logos = [guardian1, guardian2, guardian3, guardian4, guardian5];
        ...
        <div className="petopia-container">
          ...
          <div className="petopia-content">
            <div className="petopia-texts">
              <h3 className="petopia-title">Guardian</h3>
              <h3 className="petopia-title-mobile">Guardian</h3>
              <p className="petopia-desc">
                Manage your Guardian nodes and rewards
              </p>
            ...
            <div className="petopia-footer">
              ...
              <div className="petopia-buttons">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  href="https://guardian.sophon.xyz/"
                >
                  <div className="btn-inner">
                    <div className="btn-text">
              ...
              <div className="description">
                ...
                <div className="image-info">
                  <h4 className="typo-h6">
                    The official app for Sophon node operators and Guardian
                    membership holders.
                  </h4>
                  <p className="typo-p2">
                    Manage your Sophon node, track performance metrics, and
                    access exclusive features all from one sleek, intuitive
                    interface.
                  </p>
                  <p className="typo-p2">
                    <span className="txt">Key Features:</span>
                  </p>
                  ...
                  <ul>
                    ...
                    <li className="typo-p2 list-item">
                      ...
                      <p className="typo-p2">Seamless delegation controls</p>
                    </li>
                    ...
                    <li className="typo-p2 list-item">
                      ...
                      <p className="typo-p2">
                        Guardian rewards tracking and claims
                      </p>
                    </li>
                    <li className="typo-p2 list-item">
                      <svg
                      ...
                      <p className="typo-p2">
                        Network health indicators and alerts
                      </p>
                    </li>
                  </ul>
                  <p className="typo-p2">
                    Whether you're running a full node, light node, or
                    delegating your Guardian membership, this essential tool
                    keeps you connected to the Sophon ecosystem wherever you go.
                  </p>
                  <p className="typo-p2">
                    Join thousands of Guardians protecting the Sophon network
                    and shaping the future of consumer entertainment onchain.
                  </p>
                </div>
              </div>
            </div>
