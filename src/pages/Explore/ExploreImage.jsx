...
import explorerLogo from "../../assets/explorer.webp";
        ...
        <div className="petopia-container">
          ...
          <div className="petopia-content">
            <div className="petopia-texts">
              <h3 className="petopia-title">Explorer</h3>
              <h3 className="petopia-title-mobile">Explorer</h3>
              <p className="petopia-desc">
                Browse Sophon's transactions, blocks, tokens, and more
              </p>
            ...
            <div className="petopia-footer">
              <div className="petopia-labels">
                <p className="petopia-company">Sophons Labs</p>
          ...
          <div className="description-container">
            <div className="description">
              ...
              <div className="image-info">
                ...
                <p className="typo-p2">
                  The Sophon Block Explorer provides comprehensive insights into
                  the Sophon network. Users can view transactions, blocks, token
                  transfers, and network statistics in real-time.
                </p>
              </div>
            </div>
          </div>
