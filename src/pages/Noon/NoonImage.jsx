...
import noon1 from "../../assets/noon1.webp";
import noon2 from "../../assets/noon2.webp";
import noon3 from "../../assets/noon3.webp";
import noon4 from "../../assets/noon4.webp";
import noon5 from "../../assets/noon5.webp";

const logos = [noon1, noon2, noon3, noon4, noon5];
        ...
        <div className="petopia-container">
          ...
          <div className="petopia-content">
            <div className="petopia-texts">
              <h3 className="petopia-title">Noon</h3>
              <h3 className="petopia-title-mobile">Noon</h3>
              <p className="petopia-desc">
                A smart yield-generating stable coin
              </p>
            ...
            <div className="petopia-footer">
              <div className="petopia-labels">
                <p className="petopia-company">Noon</p>
            ...
            <div className="description-container">
              <div className="description">
                ...
                <div className="image-info">
                  ...
                  <p className="typo-p2">
                    Noon is a smart stablecoin designed with intelligent capital
                    allocation. Noon aims to provide users with a stablecoin
                    option that utilizes delta-neutral strategies while
                  ...
                  <p className="typo-p2">
                    🧠{" "}
                    <span className="txt">Intelligent Capital Allocation</span>{" "}
                    – Benefit from a stablecoin that employs delta-neutral
                    strategies managed by the protocol's intelligence systems.
                  </p>
                  <p className="typo-p2">
                    ⚖️ <span className="txt">Fair Value Distribution</span> –
                    Over 90% of Noon's raw returns are allocated back to users,
                    prioritizing user value over protocol profits.
                  </p>
                  <p className="typo-p2">
                    🌐 <span className="txt">Multi-Chain Availability</span> –
                    Access Noon across Sophon, Ethereum, ZKSync and other
                    networks, providing flexibility in where you use the
                    stablecoin.
                  </p>
                  <p className="typo-p2">
                    🏛️ <span className="txt">Sustainable Tokenomics</span> –
                    Participate in a governance model where 65-80% of tokens are
                    distributed to users, creating alignment between the
                    protocol and its community.
                  </p>
                  <p className="typo-p2">
                    🔄 <span className="txt">Use across Sophon</span> – Use Noon
                    through protocols such as Syncswap across asset pairs.
                  </p>
                  ...
                  <ul>
                    <li className="list-item">
                      ...
                      <p class="typo-p2">
                        ...
                        <a
                          href="https://app.sophon.xyz/detail/noon"
                          rel="noopener noreferrer"
                          className="list-link"
                        >
                          https://app.sophon.xyz/detail/noon
                        </a>
                      </p>
                    </li>
                    <li className="list-item">
                    ...
                    <li className="list-item">
                      ...
                      <p className="typo-p2">
                        ...
                        <a
                          href="https://t.me/nooncapital"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="list-link"
                        >
                          https://t.me/nooncapital
                        </a>
                      </p>
                    </li>
                    <li className="list-item">
                    ...
                    <li className="list-item">
                      ...
                      <p className="typo-p2">
                        <span className="txt">Terms:</span>{" "}
                        <a
                          href="https://noon.capital/terms-and-conditions"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="list-link"
                        >
                          https://noon.capital/terms-and-conditions
                        </a>
                      </p>
                    </li>
                  </ul>
