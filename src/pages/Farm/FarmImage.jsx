...
import farmLogo from "../../assets/farm.webp";
import farm1 from "../../assets/farm1.webp";
import farm2 from "../../assets/farm2.webp";
import farm3 from "../../assets/farm3.webp";
import farm4 from "../../assets/farm4.webp";
const logos = [farm1, farm2, farm3, farm4];
        ...
        <div className="petopia-container">
          ...
          <div className="petopia-content">
            <div className="petopia-texts">
              <h3 className="petopia-title">The Farm</h3>
              <h3 className="petopia-title-mobile">The Farm</h3>
              <p className="petopia-desc">
                Farm and accrue points that become $SOPH
              </p>
            ...
            <div className="description-container">
              <div className="description">
                ...
                <div className="image-info">
                  <p className="typo-p2">
                    <span className="txt">Join the Sophon Farm</span> and
                    contribute to the future of entertainment onchain. Provide
                    liquidity, receive Sophon Points (SP), and participate in
                    the growth of the platform as an early supporter.
                  </p>
                  ...
                  <ul>
                    <li className="typo-p2 list-item">
                      ...
                      <p className="typo-p2">
                        Contribute liquidity to essential ecosystem pairs
                      </p>
                    </li>
                    ...
                    <li className="typo-p2 list-item">
                      ...
                      <p className="typo-p2">
                        Collect Sophon Points (SP) for your participation
                      </p>
                    </li>
                    ...
                    <li className="typo-p2 list-item">
                      ...
                      <p className="typo-p2">
                        Create and customize your personal Farmer profile
                      </p>
                    </li>
                  </ul>
                  <p className="typo-p2">
                    The <span className="txt">Sophon Farm</span> offers the
                    ultimate farming experience with a beautiful interface that
                    makes participating in the ecosystem both enjoyable and
                    meaningful.
                  </p>
                </div>
              </div>
