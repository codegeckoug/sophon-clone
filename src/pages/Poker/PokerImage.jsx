...
import pokerLogo from "../../assets/lepoker.webp";
import poker1 from "../../assets/lepoker1.webp";
import poker2 from "../../assets/lepoker2.png";
import poker3 from "../../assets/lepoker3.png";
import poker4 from "../../assets/lepoker4.png";
import poker5 from "../../assets/lepoker5.png";
import poker6 from "../../assets/lepoker6.png";
const logos = [poker1, poker2, poker3, poker4, poker5, poker6];
        ...
        <div className="petopia-container">
          ...
          <div className="petopia-content">
            <div className="petopia-texts">
              <h3 className="petopia-title">Le Poker</h3>
              <h3 className="petopia-title-mobile">Le Poker</h3>
              <p className="petopia-desc">Free & Fair community poker games</p>
              <p className="petopia-desc-mobile">
                Free & Fair community poker games
              </p>
            </div>

            <div className="petopia-footer">
              <div className="petopia-labels">
                <p className="petopia-company">LePoker</p>
                <div className="petopia-badge-wrapper">
                  <div className="petopia-badge">
                    <p className="petopia-badge-text">Lifestyle</p>
                  </div>
                </div>
              </div>
              ...
              <div className="petopia-buttons">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  href="https://app.lepoker.io/home?r=U1F5mm"
                >
                  <div className="btn-inner">
                    <div className="btn-text">
            ...
            <div className="description-container">
              <div className="description">
                ...
                <div className="image-info">
                  ...
                  <p className="typo-p2">
                    LéPoker is a community-focused poker platform that offers
                    free and fair games with real rewards. We combine
                    cutting-edge blockchain technology with classic poker
                    gameplay to create a transparent, customizable gaming
                    experience that's welcoming to beginners while satisfying
                    experienced players.
                  </p>
                  ...
                  <p className="typo-p2">
                    🎮 <span className="txt">Play For Free</span> – Access
                    various free-entry games and events with real rewards,
                    making poker accessible even if you're just starting out.
                  </p>
                  <p className="typo-p2">
                    💸 <span className="txt">Real Rewards</span> – Earn actual
                    value for your poker skills rather than just playing for
                    fun, with various prize structures available.
                  </p>
                  <p className="typo-p2">
                    🏆 <span className="txt">Large-Scale Tournaments</span> –
                    Join or host massive tournaments supporting up to 5,000
                    players, perfect for creating memorable community events.
                  </p>
                  <p className="typo-p2">
                    🛡️ <span className="txt">Guaranteed Fairness</span> – Rest
                    easy knowing all games use on-chain shuffling with zk-SNARKs
                    and VDF technology to ensure absolute randomness and
                    fairness.
                  </p>
                  <p className="typo-p2">
                    🎨 <span className="txt">Custom Gaming Experience</span> –
                    Personalize your games by adjusting chip values, table
                    styles, and other elements to match your preferences or
                    branding.
                  </p>
                  ...
                  <ul>
                    <li className="list-item">
                      ...
                      <p class="typo-p2">
                        ...
                        <a
                          href="https://linktr.ee/lepokergame"
                          rel="noopener noreferrer"
                          className="list-link"
                        >
                          https://linktr.ee/lepokergame
                        </a>
                      </p>
                    </li>
                  </ul>
