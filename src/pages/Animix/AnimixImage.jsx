...
import animixLogo from "../../assets/animix.webp";
import animix1 from "../../assets/animix1.webp";
import animix2 from "../../assets/animix2.webp";
import animix3 from "../../assets/animix3.webp";
import animix4 from "../../assets/animix4.webp";
import animix5 from "../../assets/animix5.webp";
import animix6 from "../../assets/animix6.webp";
import animix7 from "../../assets/animix7.webp";
import animix8 from "../../assets/animix8.webp";
import animix9 from "../../assets/animix9.webp";
import animix10 from "../../assets/animix10.webp";
import animix11 from "../../assets/animix11.webp";
import animix12 from "../../assets/animix12.webp";
        ...
        <div className="petopia-container">
          ...
          <div className="petopia-content">
            <div className="petopia-texts">
              <h3 className="petopia-title">Animix</h3>
              <h3 className="petopia-title-mobile">Animix</h3>
            ...
            <div className="petopia-footer">
              <div className="petopia-labels">
                <p className="petopia-company">Animix</p>
              ...
              <div className="petopia-buttons">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  href="https://t.me/animix_game_bot"
                >
                  <div className="btn-inner">
                    <div className="btn-text">
            ...
            <div className="description-container">
              <div className="description">
                ...
                <div className="image-info">
                  ...
                  <p className="typo-p2">
                    Animix is the first GenAI-powered pet fusion game on
                    Telegram, where imagination meets AI. Create one-of-a-kind
                    fantasy pets by fusing magical DNA, with each creature
                    uniquely brought to life through generative AI. Discover
                    pets across various rarity tiers, from Common to Mythical,
                    while engaging in clan competitions, missions, and thrilling
                    arena battles - all within an accessible and social gaming
                    experience.
                  </p>
                  ...
                  <p className="typo-p2">
                    🧬 <span className="txt">Creative DNA Fusion</span> – Mix
                    different DNA types to create your own magical creatures
                    with unique appearances and abilities that reflect your
                    creative choices.
                  </p>

                  <p className="typo-p2">
                    🎨 <span className="txt">AI-Generated Unique Pets</span> –
                    Watch as generative AI transforms your DNA combinations into
                    beautiful, one-of-a-kind fantasy creatures that no other
                    player will have.
                  </p>

                  <p className="typo-p2">
                    ⚔️ <span className="txt">Exciting Battle System</span> –
                    Test your strategy in the Arena by assembling your strongest
                    team to battle other players and earn valuable rewards.
                  </p>

                  <p className="typo-p2">
                    👥 <span className="txt">Social Clan Experience</span> –
                    Join forces with friends in clans to participate in
                    exclusive events, earn special rewards, and build a
                    community of fellow pet enthusiasts.
                  </p>

                  <p className="typo-p2">
                    💎 <span className="txt">Discover Rare Creatures</span> –
                    Hunt for pets across multiple rarity tiers from Common to
                    Mythical, with each higher tier offering more powerful
                    abilities and unique traits.
                  </p>

                  <p className="typo-p2">
                    🎯 <span className="txt">Mission-Based Gameplay</span> –
                    Complete various missions to earn Airdrop Points and DNA,
                    allowing for progress even when you're not actively
                    battling.
                  </p>

                  <p className="typo-p2">
                    📱 <span className="txt">Telegram Integration</span> – Play
                    directly through Telegram without downloading additional
                    apps, making it easy to engage with the game wherever you
                    are.
                  </p>
                  ...
                  <ul>
                    ...
                    <li className="list-item">
                      ...
                      <p className="typo-p2">
                        <span className="txt">Web:</span>{" "}
                        <a
                          href="https://www.animix.tech/"
                          rel="noopener noreferrer"
                          className="list-link"
                        >
                          https://www.animix.tech/
                        </a>
                      </p>
                    </li>
                  </ul>
