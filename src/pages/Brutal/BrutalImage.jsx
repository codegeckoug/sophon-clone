...
import brutalLogo from "../../assets/brutal.webp";
import brutal1 from "../../assets/brutal1.webp";
import brutal2 from "../../assets/brutal3.webp";
import brutal3 from "../../assets/brutal4.webp";

const logos = [brutal1, brutal2, brutal3];
        ...
        <div className="petopia-container">
          ...
          <div className="petopia-content">
            <div className="petopia-texts">
              <h3 className="petopia-title">Brutal Knights</h3>
              <h3 className="petopia-title-mobile">Brutal Knights</h3>
              <p className="petopia-desc">
                A medieval turn-based strategy game
              </p>
            ...
            <div className="petopia-footer">
              <div className="petopia-labels">
                <p className="petopia-company">Brutal Knigts</p>
              ...
              <div className="petopia-buttons">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  href="https://www.brutalknights.xyz/"
                >
                  <div className="btn-inner">
                    <div className="btn-text">
            ...
            <div className="description-container">
              <div className="description">
                ...
                <div className="image-info">
                  ...
                  <p className="typo-p2">
                    Brutal Knights is a medieval turn-based strategy game where
                    each Knight is not just a character with rich lore, but a
                    unique, tradable asset within the ecosystem. Set in a dark
                    fantasy world, the game combines tactical combat with
                    permanent consequences, creating intense gameplay where your
                    decisions truly matter both on and off the battlefield.
                  </p>

                  <hr className="divider"></hr>
                  <h4 className="typo-h6">Features &amp; Benefits</h4>
                  <p className="typo-p2">
                    🏰 <span className="txt">Multiple Game Modes</span> –
                    Experience diverse challenges from roguelike Dungeon
                    Crawling to strategic PVP matches and high-stakes Extraction
                    missions.
                  </p>
                  <p className="typo-p2">
                    ⚔️ <span className="txt">True Asset Ownership</span> – Own
                    your Knights and items completely, with the freedom to
                    trade, enhance, or stake them to increase their value and
                    utility.
                  </p>
                  <p className="typo-p2">
                    💀 <span className="txt">Consequential Gameplay</span> –
                    Feel the weight of every decision with permadeath mechanics
                    in certain modes, where your choices have real impact.
                  </p>
                  <p className="typo-p2">
                    🎮 <span className="txt">Accessible Entry Points</span> –
                    Jump in through free-to-play modes with browser and mobile
                    crossplay, offering casual experiences alongside hardcore
                    options.
                  </p>
                  <p className="typo-p2">
                    💰 <span className="txt">Rewarding Risk System</span> – Earn
                    greater rewards by taking calculated risks, including rare
                    loot drops, instant airdrop bounties, and community unlocks.
                  </p>
                  <p className="typo-p2">
                    🔄 <span className="txt">Evolving Meta-Game</span> – Adapt
                    your strategies as the game ecosystem shifts, with new
                    Knights, abilities, and tactics emerging from player
                    activity.
                  </p>
                  <p className="typo-p2">
                    🎯 <span className="txt">Tactical Depth</span> – Master
                    complex turn-based combat that rewards planning,
                    positioning, and intelligent resource management.
                  </p>
                  ...
                  <ul>
                    <li className="list-item">
                      ...
                      <p class="typo-p2">
                        <span class="txt">Discord:</span>{" "}
                        <a
                          href="https://discord.com/invite/brutalknights"
                          rel="noopener noreferrer"
                          className="list-link"
                        >
                          https://discord.com/invite/brutalknights
                        </a>
                      </p>
                    </li>
                  </ul>
