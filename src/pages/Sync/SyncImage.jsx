        ...
        <div className="petopia-container">
          ...
          <div className="petopia-content">
            <div className="petopia-texts">
              <h3 className="petopia-title">SyncSwap</h3>
              <h3 className="petopia-title-mobile">SyncSwap</h3>
              <p className="petopia-desc">Trade your tokens seamlessly</p>
            ...
            <div className="petopia-footer">
              <div className="petopia-labels">
                <p className="petopia-company">SyncSwap</p>
            ...
            <div className="description-container">
              <div className="description">
                ...
                <div className="image-info">
                  ...
                  <p className="typo-p2">
                    SyncSwap is a user-friendly decentralized exchange available
                    on Sophon, making it easy to trade tokens without
                    complicated steps or high fees. Designed with simplicity in
                    mind, SyncSwap helps you swap tokens, get rewards, and
                    manage your digital assets all in one place.
                  </p>

                  <hr className="divider"></hr>
                  <h4 className="typo-h6">Features &amp; Benefits</h4>
                  <p className="typo-p2">
                    👆 <span className="txt">One-Click Trading</span> – Swap
                    your tokens with just a few clicks through a clean,
                    straightforward interface that eliminates confusion.
                  </p>

                  <p className="typo-p2">
                    💸 <span className="txt">Keep More of Your Money</span> –
                    Benefit from low cost fees while swapping.
                  </p>

                  <p className="typo-p2">
                    ⏱️ <span className="txt">No More Waiting</span> – Complete
                    your trades in seconds on Sophon.
                  </p>

                  <p className="typo-p2">
                    🛡️ <span className="txt">Trade Without Worry</span> – Enjoy
                    peace of mind with security that protects your assets
                  ...
                  <ul>
                    <li className="list-item">
                      ...
                      <p class="typo-p2">
                        ...
                        <a
                          href="https://docs.syncswap.xyz/syncswap"
                          rel="noopener noreferrer"
                          className="list-link"
                        >
                          https://docs.syncswap.xyz/syncswap
                        </a>
                      </p>
                    </li>
                    <li className="list-item">
                      ...
                      <p className="typo-p2">
                        <span className="txt">Security:</span>{" "}
                        <a
                          href="https://docs.syncswap.xyz/syncswap/smart-contracts/security"
                          rel="noopener noreferrer"
                          className="list-link"
                        >
                          https://docs.syncswap.xyz/syncswap/smart-contracts/security
                        </a>
                      </p>
                    </li>
                    <li className="list-item">
                      ...
                      <p className="typo-p2">
                        <span className="txt">Smart Contract:</span>{" "}
                        <a
                          href="https://docs.syncswap.xyz/syncswap/smart-contracts/smart-contracts"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="list-link"
                        >
                          https://docs.syncswap.xyz/syncswap/smart-contracts/smart-contracts
                        </a>
                      </p>
                    </li>
                  </ul>
