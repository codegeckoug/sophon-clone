        ...
        <div className="petopia-container">
          ...
          <div className="petopia-content">
            <div className="petopia-texts">
              <h3 className="petopia-title">Nova</h3>
              <h3 className="petopia-title-mobile">Nova</h3>
              <p className="petopia-desc">
                Play fun mini-games, earn rewards &amp; points
              </p>
            ...
            <div className="petopia-footer">
              <div className="petopia-labels">
                <p className="petopia-company">Anomaly Games</p>
              ...
              <div className="petopia-buttons">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  href="https://t.me/anomaly_launch_bot"
                >
                  <div className="btn-inner">
                    <div className="btn-text">
            ...
            <div className="description-container">
              <div className="description">
                ...
                <div className="image-info">
                  ...
                  <p className="typo-p2">
                    Collect Nova Points as you play through a variety of fun,
                    quick games designed for casual entertainment on the go.
                  </p>

                  <hr className="divider"></hr>
                  <h4 className="typo-h6">Features &amp; Benefits</h4>
                  <p className="typo-p2">
                    🎮 <span className="txt">Multiple Mini-Games</span> – Enjoy
                    a variety of fun games including Nova Scenario, Block Break,
                    Dicestone, Get Plucked, and Pinball.
                  </p>
                  <p className="typo-p2">
                    📱 <span className="txt">Play Anywhere</span> – Access all
                    games instantly through Telegram without downloading
                    additional apps or navigating complex interfaces.
                  </p>
                  <p className="typo-p2">
                    🏆 <span className="txt">Earn Nova Points</span> – Collect
                    points across different games that track your progress and
                    achievements in the Nova ecosystem.
                  </p>
                  <p className="typo-p2">
                    🎁 <span className="txt">Regular Rewards</span> – Benefit
                    from Anomaly's partnerships with top gaming IPs and
                    blockchains through airdrops, tokens, and NFTs distributed
                    to active players.
                  </p>
                  <p className="typo-p2">
                    🔄 <span className="txt">Constant Updates</span> –
                    Experience new games and features regularly as Anomaly
                    continues to expand the Nova gaming collection.
                  </p>
                  ...
                  <ul>
                    ...
                    <li className="list-item">
                      ...
                      <p className="typo-p2">
                        <span className="txt">Links:</span>{" "}
                        <a
                          href="https://linktr.ee/anomalygames"
                          rel="noopener noreferrer"
                          className="list-link"
                        >
                          https://linktr.ee/anomalygames
                        </a>
                      </p>
                    </li>
                    <li className="list-item">
                      ...
                      <p className="typo-p2">
                        ...
                        <a
                          href="https://www.anomalygames.ai/"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="list-link"
                        >
                          https://www.anomalygames.ai/
                        </a>
                      </p>
                    </li>
                  </ul>
