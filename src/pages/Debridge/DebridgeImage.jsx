...
import debridgeLogo from "../../assets/debridge.webp";
import debridge1 from "../../assets/debridge2.webp";
import debridge2 from "../../assets/debridge1.webp";
import debridge3 from "../../assets/debridge3.webp";
import debridge4 from "../../assets/debridge4.webp";
const logos = [debridge1, debridge2, debridge3, debridge4];
function Sidebar() {
        ...
        <div className="petopia-container">
          ...
          <div className="petopia-content">
            <div className="petopia-texts">
              <h3 className="petopia-title">deBridge</h3>
              <h3 className="petopia-title-mobile">deBridge</h3>
              <p className="petopia-desc">
                Transfer crypto assets at lightspeed
              </p>
            ...
            <div className="petopia-footer">
              <div className="petopia-labels">
                <p className="petopia-company">deBridge</p>
            ...
            <div className="description-container">
              <div className="description">
                ...
                <div className="image-info">
                  ...
                  <p className="typo-p2">
                    <span className="txt">deBridge</span> is a cross-chain
                    bridge focused on enabling instant and seamless transfers
                    between any liquid crypto assets. Transfer your tokens
                    between different blockchains at lightspeed with minimal
                    friction, making it easy to access opportunities across the
                    entire crypto ecosystem without being locked into a single
                    network.
                  </p>
                  ...
                  <p className="typo-p2">
                    ⚡ <span className="txt">Lightning-Fast Transfers</span> –
                    Move your crypto assets between blockchains in seconds
                    rather than waiting minutes or hours for transactions to
                    complete.
                    <br />
                    🔄 <span className="txt">Support for Any Asset</span> –
                    Transfer virtually any liquid cryptocurrency across
                    supported networks without being limited to specific tokens.
                    <br />
                    💸 <span className="txt">Cost-Effective Bridging</span> –
                    Save money on transfer fees with optimized routing that
                    finds the most efficient path for your transactions.
                    <br />
                    🌐 <span className="txt">Multi-Chain Access</span> – Connect
                    to multiple blockchain networks through one platform,
                    eliminating the need to use different bridges for different
                    chains.
                    <br />
                    🛡️ <span className="txt">Secure Infrastructure</span> –
                    Trust in proven technology that protects your assets during
                    cross-chain transfers with robust security measures.
                    <br />
                    🎯 <span className="txt">Simple User Experience</span> –
                    Complete complex cross-chain transfers through an intuitive
                  ...
                  <ul>
                    <li className="list-item">
                      <p class="typo-p2">
                        ...
                        <a
                          href="https://docs.debridge.finance/"
