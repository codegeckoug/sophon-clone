...
import playLogo from "../../assets/play.webp";
import play1 from "../../assets/play1.webp";
import play2 from "../../assets/play2.webp";
import play3 from "../../assets/play3.webp";

const logos = [play1, play2, play3];
        ...
        <div className="petopia-container">
          ...
          <div className="petopia-content">
            <div className="petopia-texts">
              <h3 className="petopia-title">(((+)))</h3>
              <h3 className="petopia-title-mobile">(((+)))</h3>
              <p className="petopia-desc">
                Your mastery may echo through the void
              </p>
            ...
            <div className="description-container">
              <div className="description">
                ...
                <div className="image-info">
                  <p className="typo-p2">
                    Step into the <span className="txt">Sophon universe</span>{" "}
                    with this addictive minigame that's simple to play but hard
                    to master. Aim your cannon, adjust your power, and launch
                    projectiles to hit targets in this physics-based challenge.
                  </p>
                  ...
                  <ul>
                    <li className="typo-p2 list-item">
                      ...
                      <p className="typo-p2">Intuitive one-touch gameplay</p>
                    </li>
                    ...
                    <li className="typo-p2 list-item">
                      ...
                      <p className="typo-p2">
                        No wallet or crypto knowledge required to start
                      </p>
                    </li>
                  ...
                  <p className="typo-p2">
                    ...
                    <span className="txt">Sophon Cannon</span> offers a fun,
                    accessible introduction to the Sophon universe. Challenge
                    friends to beat your high score and discover the
                    entertaining side of the platform.
                  </p>
                </div>
              </div>
            </div>
