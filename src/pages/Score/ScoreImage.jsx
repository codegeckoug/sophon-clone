...
import scoreLogo from "../../assets/scoreplay.webp";
import score1 from "../../assets/scoreplay1.webp";
import score2 from "../../assets/scoreplay2.webp";
import score3 from "../../assets/scoreplay3.webp";
import score4 from "../../assets/scoreplay4.webp";
import score5 from "../../assets/scoreplay5.webp";
const logos = [score1, score2, score3, score4, score5];
        ...
        <div className="petopia-container">
          ...
          <div className="petopia-content">
            <div className="petopia-texts">
              <h3 className="petopia-title">ScorePlay</h3>
              <h3 className="petopia-title-mobile">ScorePlay</h3>
              <p className="petopia-desc">
                AI-powered sports information market
              </p>
            ...
            <div className="petopia-footer">
              <div className="petopia-labels">
                <p className="petopia-company">ScorePlay</p>
              ...
              <div className="petopia-buttons">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  href="https://scoreplay.xyz/compete"
                >
                  <div className="btn-inner">
                    <div className="btn-text">
            ...
            <div className="description-container">
              <div className="description">
                ...
                <div className="image-info">
                  ...
                  <p className="typo-p2">
                    <span className="txt">ScorePlay</span> is the first
                    decentralized sports prediction platform built for sports
                    fans. We combine the transparency of peer-to-peer prediction
                    markets with the simplicity, excitement, and scale of
                    traditional sportsbooks — without the friction. Whether
                    you're here to test your football knowledge, climb the
                    global leaderboard, or just have fun with friends, ScorePlay
                    turns your sports insights into real rewards!
                  </p>

                  <hr className="divider"></hr>
                  <h4 className="typo-h6">Features &amp; Benefits</h4>
                  <p className="typo-p2">
                    ⚖️ <span className="txt">No House Edge</span> – Compete
                    directly against other fans in pooled markets instead of
                    battling a bookmaker designed to take your money.
                    <br />
                    🔍 <span className="txt">Transparent and Fair</span> – See
                    every prediction, payout, and prize pool handled openly
                    through smart contracts that can't cheat or manipulate
                    results.
                    <br />
                    👥 <span className="txt">Social Competition</span> – Join
                    leaderboards, creator leagues, and referral systems that
                    turn predictions into shared competition with friends and
                    community.
                    <br />
                    🚀 <span className="txt">Easy to Start</span> – Simple
                    onboarding for casual players with seamless USDC gameplay
                    for serious predictors, without confusing DeFi terminology.
                    <br />
                    🏆 <span className="txt">Test Your Knowledge</span> – Put
                    your sports expertise to the test and earn rewards based on
                    your actual understanding of games and players.
                    <br />
                    💰 <span className="txt">Fair Payouts</span> – Win based on
                    your prediction skills, with all winnings coming from other
                    participants rather than a house that profits from your
                    losses.
                  </p>
                  ...
                  <ul>
                    ...
                    <li className="list-item">
                      ...
                      <p className="typo-p2">
                        ...
                        <a
                          href="https://discord.com/invite/a5gvyYmPb9"
                          rel="noopener noreferrer"
                          className="list-link"
                        >
                          https://discord.com/invite/a5gvyYmPb9
                        </a>
                      </p>
                    </li>
                    <li className="list-item">
                      ...
                      <p className="typo-p2">
                        <span className="txt">Security Audits:</span>{" "}
                        <a
                          href="https://www.octane.security/post/octane-smart-contract-security-for-scoreplay"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="list-link"
                        >
