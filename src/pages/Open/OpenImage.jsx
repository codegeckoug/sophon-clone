...
import openLogo from "../../assets/open.webp";
import open1 from "../../assets/open1.webp";
import open2 from "../../assets/open2.mp4";

const logos = [
  { type: "image", src: open1 },
  { type: "video", src: open2 },
];
        ...
        <div className="petopia-container">
          ...
          <div className="petopia-content">
            <div className="petopia-texts">
              <h3 className="petopia-title">OPEN</h3>
              <h3 className="petopia-title-mobile">OPEN</h3>
              <p className="petopia-desc">
                Buy tickets to major events onchain
              </p>
            ...
            <div className="petopia-footer">
              <div className="petopia-labels">
                <p className="petopia-company">Open Ticketing</p>
                  ...
                  <div className="image">
                    <a href="/openpicture">
                      {logo.type === "image" ? (
                        ...
                        <video
                          src={logo.src} // ✅ also use logo.src here
                          autoPlay
                          loop
                          muted
                          playsInline
            ...
            <div className="description-container">
              <div className="description">
                ...
                <div className="image-info">
                  ...
                  <p className="typo-p2">
                    OPEN is revolutionizing the ticketing industry by bringing
                    honest and transparent practices through blockchain
                    technology. Born in 2016, we've become the market leader in
                    NFT Ticket &amp; Digital Collectible infrastructure, having
                    issued over 8.5 million NFT Tickets across more than 25,000
                    events. Our technology puts all complexity behind the
                    scenes, delivering a better ticketing experience for real
                    fans.
                  </p>
                  ...
                  <p className="typo-p2">
                    💵 <span className="txt">Pay Fair Prices</span> – Get
                    tickets at face value without excessive markups from
                    scalpers and resellers, saving you money on every event.
                  </p>
                  <p className="typo-p2">
                    🎁 <span className="txt">Collect Event Memorabilia</span> –
                    Receive digital collectibles with your tickets that
                    commemorate your attendance and may increase in value over
                    time.
                  </p>
                  <p className="typo-p2">
                    ✅ <span className="txt">Guaranteed Authenticity</span> –
                    Purchase with confidence knowing your tickets are 100%
                    verified and can't be counterfeited or duplicated.
                  </p>
                  <p className="typo-p2">
                    🔄 <span className="txt">Easy Reselling</span> – Transfer or
                    resell your tickets securely if you can't attend, without
                    complicated processes or unreasonable fees.
                  </p>
                  ...
                  <ul>
                    <li className="list-item">
                      ...
                      <p className="typo-p2">
                        ...
                        <a
                          href="https://x.com/onopenxyz"
                          rel="noopener noreferrer"
                          className="list-link"
                        >
                          https://x.com/onopenxyz
                        </a>
                      </p>
                    </li>
                    <li className="list-item">
                      ...
                      <p className="typo-p2">
                        <span className="txt">community:</span>{" "}
                        <a
                          href="https://hub.onopen.xyz/join"
                          rel="noopener noreferrer"
                          className="list-link"
                        >
                          https://hub.onopen.xyz/join
                        </a>
                      </p>
                    </li>
                    <li className="list-item">
                      ...
                      <p className="typo-p2">
                        ...
                        <a
                          href="https://mirror.xyz/openticketing.eth"
                          rel="noopener noreferrer"
                          className="list-link"
                        >
                          https://mirror.xyz/openticketing.eth
                        </a>
                      </p>
                    </li>
                    <li className="list-item">
                      ...
                      <p className="typo-p2">
                        ...
                        <a
                          href="https://docs.onopen.xyz/"
                          rel="noopener noreferrer"
                          className="list-link"
                        >
                          https://docs.onopen.xyz/
                        </a>
                      </p>
                    </li>
                    <li className="list-item">
                      ...
                      <p className="typo-p2">
                        ...
                        <a
                          href="https://t.me/openticketing"
                          rel="noopener noreferrer"
                          className="list-link"
                        >
                          https://t.me/openticketing
                        </a>
                      </p>
                    </li>
                  </ul>
