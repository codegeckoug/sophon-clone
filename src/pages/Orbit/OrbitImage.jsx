...
import orbitLogo from "../../assets/orbiter.webp";
import orbit1 from "../../assets/orbiter1.webp";
import orbit2 from "../../assets/orbiter2.webp";

const logos = [orbit1, orbit2];
        ...
        <div className="petopia-container">
          ...
          <div className="petopia-content">
            <div className="petopia-texts">
              <h3 className="petopia-title">Orbiter</h3>
              <h3 className="petopia-title-mobile">Orbiter</h3>
              <p className="petopia-desc">
                A decentralized cross-rollup bridge that offers secure, low cost
                and almost instant transfer
              </p>
            ...
            <div className="petopia-footer">
              <div className="petopia-labels">
                <p className="petopia-company">Orbiter</p>
            ...
            <div className="description-container">
              <div className="description">
                ...
                <div className="image-info">
                  ...
                  <p className="typo-p2">
                    Orbiter Finance is a decentralized cross-rollup bridge that
                    offers secure, low cost and almost instant transfers between
                    Sophon, Ethereum and various other Layer 2 networks. Our
                    platform makes moving your crypto assets across different
                    blockchain ecosystems simple, affordable, and reliable
                  ...
                  <p className="typo-p2">
                    🔄 <span className="txt">Simple User Interface</span> –
                    Complete cross-chain transfers in just a few clicks with an
                    intuitive design that eliminates complexity.
                  </p>
                  <p className="typo-p2">
                    ⚡ <span className="txt">Near-Instant Transfers</span> –
                    Move your assets between networks in seconds rather than
                    waiting minutes or hours for confirmations.
                  </p>
                  <p className="typo-p2">
                    💰 <span className="txt">Minimal Fees</span> – Save
                    significantly on transaction costs compared to using Layer 1
                    directly, keeping more of your funds for actual use.
                  </p>
                  <p className="typo-p2">
                    🔒 <span className="txt">Security-First Design</span> –
                    Benefit from a non-custodial architecture that never takes
                    control of your assets during the bridging process.
                  </p>
                  <p className="typo-p2">
                    🌉 <span className="txt">Wide Network Support</span> –
                    Access seamless transfers across major networks including
                    Sophon, Ethereum, Arbitrum, Optimism, zkSync, and many
                    others.
                  </p>
                  ...
                  <ul>
                    <li className="list-item">
                      ...
                      <p className="typo-p2">
                        ...
                        <a
                          href="https://x.com/Orbiter_Finance"
