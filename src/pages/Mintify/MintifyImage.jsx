...
import mintifyLogo from "../../assets/mintify.webp";
import mintify1 from "../../assets/mintify1.webp";
import mintify2 from "../../assets/mintify2.webp";
import mintify3 from "../../assets/mintify3.webp";
import mintify4 from "../../assets/mintify4.webp";
import mintify5 from "../../assets/mintify5.webp";
import mintify6 from "../../assets/mintify6.webp";
const logos = [mintify1, mintify2, mintify3, mintify4, mintify5, mintify6];
        ...
        <div className="petopia-container">
          ...
          <div className="petopia-content">
            <div className="petopia-texts">
              <h3 className="petopia-title">Mintify</h3>
              <h3 className="petopia-title-mobile">Mintify</h3>
              <p className="petopia-desc">
                Trade any asset and every market onchain
              </p>
            ...
            <div className="petopia-footer">
              <div className="petopia-labels">
                <p className="petopia-company">Mintify</p>
                <div className="petopia-badge-wrapper">
                  <div className="petopia-badge">
                    <p className="petopia-badge-text">NFT</p>
                  </div>
                </div>
              </div>
            ...
            <div className="description-container">
              <div className="description">
                ...
                <div className="image-info">
                  ...
                  <p className="typo-p2">
                    Mintify lets you trade any asset and every market directly
                    onchain. Experience real-time trading of your favorite
                    digital assets without giving up control of your funds.
                    Mintify represents the next generation of trading platforms,
                    designed to be the backbone for the largest markets of the
                    21st century: digital assets, decentralized networks, and
                  ...
                  <p className="typo-p2">
                    🌐 <span className="txt">Trade Everything</span> – Access a
                    wide variety of digital assets and markets all in one place,
                    eliminating the need to use multiple platforms.
                  </p>
                  <p className="typo-p2">
                    💱 <span className="txt">Seamless Experience</span> – Enjoy
                    a smooth trading interface that makes complex onchain
                    trading feel as simple as using traditional platforms.
                  </p>
                  <p className="typo-p2">
                    ⚡ <span className="txt">Real-Time Trading</span> – Execute
                    trades instantly onchain without the delays and risks
                    associated with traditional centralized exchanges.
                  </p>
                  <p className="typo-p2">
                    🛡️ <span className="txt">Enhanced Security</span> – Avoid
                    the risk of exchange hacks or frozen accounts since your
                    assets never leave your wallet during trading.
                  </p>
                  <p className="typo-p2">
                    🔐 <span className="txt">Keep Full Control</span> – Trade
                    without depositing your assets to an exchange, maintaining
                    complete ownership and security of your funds at all times.
                  </p>
                  <p className="typo-p2">
                    🔄 <span className="txt">Direct Market Access</span> –
                    Connect directly to decentralized markets without
                    intermediaries taking control of your assets or charging
                    excessive fees.
                  </p>
                  ...
                  <ul>
                    ...
                    <li className="list-item">
                      ...
                      <p className="typo-p2">
                        <span className="txt">Foundation:</span>{" "}
                        <a
                          href="https://x.com/mintify_fnd"
                          rel="noopener noreferrer"
                          className="list-link"
                        >
                          https://x.com/mintify_fnd
                        </a>
                      </p>
                    </li>
                  </ul>
